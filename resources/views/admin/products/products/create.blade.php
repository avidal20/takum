    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="active">@lang('modules.module_gp_btn_new_products')</li>
            </ul>

            <h2>@lang('modules.module_gp_btn_new_products')</h2>

            @include('helpers.alerts')

    <form class="form-horizontal" method="post" action="{{ route('products.store',['idCategory' => $category['id'] ]) }}">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input name="price" id="price" type="number" class="form-control" required="required" min="1" step="any">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <select name="state" class="form-control" id="state" required="required">
              <option value="1">@lang('modules.module_gp_products_table_field_state_active')</option>
              <option value="2">@lang('modules.module_gp_products_table_field_state_inactive')</option>
            </select>
          </div>
        </div>
