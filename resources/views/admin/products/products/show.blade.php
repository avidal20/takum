    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="active">@lang('modules.module_gp_btn_remove_products')</li>
            </ul>

            <h2>@lang('modules.module_gp_btn_remove_products')</h2>

            @include('helpers.alerts')

    <form class="form-horizontal" method="post" action="{{ route('products.destroy',['idCategory' => $category['id'], 'id' => $product['id'] ]) }}">
        ...
        <div class="col-md-12 text-center">
          <button id="button" name="button" onclick="return confirm('@lang('modules.module_gp_msj_remove')');" class="btn btn-primary">@lang('modules.module_gp_btn_delete')</button>
        </div>
